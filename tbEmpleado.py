...
window = tkinter.Tk()
window.title("Mantenimiento tabla GZZ_EMPLEADOS")
...
def enviarBD():
    ...
    if marFlaAct:
        ...
        if estadosBotonActualizar=="insertar":
            ...
            nomTable = "GZZ_EMPLEADO"
            atributosTabla = "(AsiCod, AsiNom, EstRegCod)"
...
def llenarGrilla():
    ...
    conexion = back.establecer_conexion()
    registrosTodos = back.seleccionar(conexion,"GZZ_EMPLEADO")
    contadorGrilla=0
...
frame = tkinter.LabelFrame(window, text="GZZ_EMPLEADO")
#por buena practica este Fram contendra todos los widgets
frame.grid(row=0,column=0,sticky="nswe")

registro = tkinter.LabelFrame(frame,text="Registro de Empleados")
tabla = tkinter.LabelFrame(frame,text="Tabla_Empleados")
